...
const EdtiUserPage = () => {
  ...
  const handleAvatarChange = (event) => {
    ...
    setAvatarFile(file); // Simpan file untuk pengunggahan
  ...
  const handleSubmit = async (e) => {
    ...
    if (!username.trim() || !injectionType) {
  ...
  return (
    <div className="w-full">
      <BreadcrumbCustom pageName={'Edit user'} />
      ...
      <form onSubmit={handleSubmit} encType="multipart/form-data" className="mt-3 bg-zinc-700 p-5 rounded-sm">
        <div className="sm:flex gap-5">
          ...
          <div className="sm:w-1/2 mb-5 sm:mb-0 relative">
            ...
            <Input value={password} onChange={(e) => setPassword(e.target.value)} className={"bg-zinc-800 border-zinc-900 pr-10 text-zinc-300"} type={showPassword ? "text" : "password"} id="password" placeholder="Enter the password... " />
        ...
        <div className="sm:w-1/3 mt-5">
          ...
          <div className="flex items-center gap-2">
            <Input onChange={handleAvatarChange} accept=".jpg,.jpeg,.png" className={"bg-zinc-800 file:text-white file:font-bold  border-zinc-900 text-zinc-400"} type="file" placeholder="Enter the username... " />
